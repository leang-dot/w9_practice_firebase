...
import 'package:w9_practice_firebase/data/repositories/artist/artist_repository_firebase.dart';
...
List<InheritedProvider> get devProviders {
  ...
  return [
    ...
    Provider<ArtistRepository>(create: (context) => ArtistRepositoryFirebase(),),
